  ...
  return(
      <SafeAreaView style={styles.container}>
       ...
       <View style={styles.form}>
           <TextInput style={{borderWidth:1,borderColor:'gainsboro',borderRadius:10}} placeholder="Enter Name"/>
       </View>
       <View style={styles.form}>
           <TextInput style={{borderWidth:1,borderColor:'gainsboro',borderRadius:10}} placeholder="Enter Email"/>
       </View>
       <View style={styles.form}>
           <TextInput style={{borderWidth:1,borderColor:'gainsboro',borderRadius:10}} placeholder="Enter Country"/>
       </View>
       <View style={styles.form}>
           <TextInput style={{borderWidth:1,borderColor:'gainsboro',borderRadius:10}} placeholder="Enter Message" multiline={true} numberOfLines={5} />
       </View>
       <View style={styles.form}>
